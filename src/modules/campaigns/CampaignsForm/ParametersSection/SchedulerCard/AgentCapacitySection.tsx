...
import { Box, Slider, Text, ActionIcon, Tooltip } from '@mantine/core';
import {
	IconUsers,
	IconCalendarTime,
	IconHeadset,
		...
		<Box className={styles.container}>
			<Box className={styles.sliderRow}>
				<Text className={styles.sliderTitle}>
					{t('scheduler.capacity.title', 'Capacity')}
				</Text>
				<Tooltip
					label={t(
			...
			<Box className={styles.metricsGrid}>
				...
				<Box className={`${styles.metricCard} ${styles.metricIconTeal}`}>
					<Box className={styles.metricIconWrapper}>
						<IconHeadset size={16} />
					</Box>
					<Box className={styles.metricContent}>
				...
				<Box className={`${styles.metricCard} ${styles.metricIconOrange}`}>
					<Box className={styles.metricIconWrapper}>
						<IconUsers size={16} />
					</Box>
					<Box className={styles.metricContent}>
