...
vi.mock('@mantine/core', async (importOriginal) => {
	...
	return {
		...
		Modal: ({
			...
			if (title === 'Create Campaign Category') {
				modalCloseHandlers.create = onClose;
			} else if (title === 'Edit Campaign Category') {
...
vi.mock('../../../../hooks/useFilteredCategories', () => ({
...
describe('CampaignCategoriesContent', () => {
	...
	describe('Create modal functionality', () => {
		it('shows create modal when createModalOpened is true', () => {
			...
			expect(screen.getByText('Create Campaign Category')).toBeInTheDocument();
		...
		it('closes create modal when modal close button is clicked', () => {
			...
			const closeButton = screen.getByTestId(
				'close-modal-create-campaign-category'
			);
	...
	describe('Edit modal functionality', () => {
		...
		it('closes edit modal when modal close button is clicked', async () => {
			...
			const closeButton = screen.getByTestId(
				'close-modal-edit-campaign-category'
			);
			fireEvent.click(closeButton);
...
describe('CampaignCategoriesContent - No Results State', () => {
	...
	it('shows no results message when filtered data returns empty', async () => {
		...
		// Now simulate filtering to empty
		...
		// Now it should show the empty state for the initial load
		// The "no results" state only shows when there are categories but filtered to empty
		// Since our mock returns empty categories, it shows the global empty state
