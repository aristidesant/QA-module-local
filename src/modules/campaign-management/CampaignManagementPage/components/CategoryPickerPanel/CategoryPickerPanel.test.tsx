...
vi.mock(
	'~/modules/campaign-management/campaign-categories/components/CampaignCategoriesFilters',
	() => ({
...
vi.mock(
	'~/modules/campaign-management/campaign-categories/components/CampaignCategoriesForm/CampaignCategoriesForm',
	() => ({
