...
import { PromptInputForm } from '~/modules/prompt-generator/PromptInputForm';
import { PromptOutputDisplay } from '~/modules/prompt-generator/PromptOutputDisplay';
import { useCreatePrompt } from '~/modules/prompt-generator/queries/promptGeneratorQueries';
...
export const PromptGeneratorContent: React.FC = () => {
	...
	const { setRightComponent } = usePromptGeneratorStore();
		...
		try {
			const newPrompt = await createPrompt({
				name: selectedTypeData
					...
					: 'New Prompt',
				generationInput: values as any, // API will handle the mapping
				generatedPrompt: '', // This will be set by the server
				status: 'ACTIVE',
				promptInstructionId: selectedType,
			});
