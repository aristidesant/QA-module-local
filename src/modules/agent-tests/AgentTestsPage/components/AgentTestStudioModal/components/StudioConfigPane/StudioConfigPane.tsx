...
const StudioConfigPane = () => {
	...
	const isSubmitting = createAgentTest.isPending || updateAgentTest.isPending;

	return (
		<div className={styles.studioConfigPane}>
			<div className={styles.studioConfigContent}>
				<Tabs
					...
					classNames={{ list: styles.studioTabsList, tab: styles.studioTab }}
				>
					<Tabs.List grow>
					...
					<Tabs.Panel value='nextReply' pt='xs'>
						<Stack gap='xs'>
							<div className={styles.studioSectionBlock}>
								...
								/>
								<Text size='xs' fw={700} className={styles.studioSectionTitle}>
									{t('form.fields.successCondition')}
								</Text>
								<Textarea
							...
							<div className={styles.studioSectionBlock}>
								<Group justify='space-between' align='center'>
									<Text
										size='xs'
										fw={700}
										className={styles.studioSectionTitle}
									>
					...
					<Tabs.Panel value='toolInvocation' pt='xs'>
						<Text size='sm' c='dimmed' className={styles.toolInvocationHint}>
			...
			<Group
				className={styles.studioStickyFooterLeft}
				justify='flex-start'
				gap='xs'
			>
				<Button
