...
import type { PromptGeneratorForm, PromptGeneratorFormField } from "~/config/prompt-generator/generatorForm";
...
export const PromptGeneratorFormBuilder = ({
  ...
  const handleRemoveField = (idx: number) => {
    form.setFieldValue('fields', form.values.fields.filter((_, i) => i !== idx));
  };
  ...
  return (
    <form className={styles.container} onSubmit={form.onSubmit(onFormSubmit)}>
      ...
      <Divider />
      {form.values.fields.map((field: PromptGeneratorFormField, idx: number) => (
